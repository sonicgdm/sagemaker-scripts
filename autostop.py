...
if is_idle(last_active_time):
    ...
    sns_client.publish(TopicArn="arn:aws:sns:eu-west-1:684670500371:alarm-action",
        Message="A sagemaker instance has been stopped because of no activity on instance more than 1 hour.",
        Subject="Sagemaker notebook has been stopped")
